package com.json.xfyunise.flutter_xfyun_ise.ise.result.xml;

import android.text.TextUtils;
import android.util.Log;
import android.util.Xml;

import com.json.xfyunise.flutter_xfyun_ise.ise.result.FinalResult;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.ReadSentenceResult;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.ReadSyllableResult;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.ReadWordResult;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.IseResult;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.entity.Phone;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.entity.Sentence;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.entity.Syll;
import com.json.xfyunise.flutter_xfyun_ise.ise.result.entity.Word;
...
public class XmlResultParser {
    ...
    public IseResult parse(String xml) {
                ...
                switch (eventType) {
                    case XmlPullParser.START_TAG:
                        if ("FinalResult".equals(pullParser.getName())) {
                            ...
                            Log.e("xxxxxx123", "total_score:         " + getFloat(pullParser, "value"));
    ...
    private IseResult parseResult(XmlPullParser pullParser) {
        IseResult result = null;
        // <rec_paper>标签是否已扫描到
    ...
    private void readTotalResult(IseResult result, XmlPullParser pullParser) {
