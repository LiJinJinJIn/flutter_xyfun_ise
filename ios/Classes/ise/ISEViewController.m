...
NSString* const KCTextCNChapter=@"text_cn_chapter";

NSString* const KCTextENWord=@"text_en_word";
NSString* const KCTextENSentence=@"text_en_sentence";
NSString* const KCTextENChapter=@"text_en_chapter";
NSString* const KCTextENExpressionBase64Encoding=@"text_en_expression_base64encoding";
NSString* const KCTextENChoiceBase64Encoding=@"text_en_choice_base64encoding";
NSString* const KCTextENTopicBase64Encoding=@"text_en_topic_base64encoding";
NSString* const KCTextENRetellBase64Encoding=@"text_en_retell_base64encoding";
NSString* const KCTextENPictureBase64Encoding=@"text_en_picture_base64encoding";
NSString* const KCTextENTranslationBase64Encoding=@"text_en_translation_base64encoding";
...
static NSString *LocalizedEvaString(NSString *key, NSString *comment) {
    if ([key containsString:@"base64"]) {
        NSString *base64String = NSLocalizedStringFromTable(key, @"eva/eva", comment);
...
-(void)reloadCategoryText{
    ...
    if ([self.iseParams.language isEqualToString:KCLanguageZHCN]) {
        ...
        else if ([self.iseParams.category isEqualToString:KCCategorySentence]) {
            self.textView.text = LocalizedEvaString(KCTextCNSentence, nil);
        }
        else if ([self.iseParams.category isEqualToString:KCCategoryChapter]) {
            self.textView.text = LocalizedEvaString(KCTextCNChapter, nil);
        }
    }
    else {
        ...
        if ([self.iseParams.category isEqualToString:KCCategoryWord]) {
            ...
            self.textView.text = LocalizedEvaString(KCTextENChapter, nil);
        }
        else if ([self.iseParams.category isEqualToString:KCCategoryExpression]) {
            self.textView.text = LocalizedEvaString(KCTextENExpressionBase64Encoding, nil);
        }
        else if ([self.iseParams.category isEqualToString:KCCategoryChoice]) {
            self.textView.text = LocalizedEvaString(KCTextENChoiceBase64Encoding, nil);
        }
        else if ([self.iseParams.category isEqualToString:KCCategoryTopic]) {
            self.textView.text = LocalizedEvaString(KCTextENTopicBase64Encoding, nil);
        }
        else if ([self.iseParams.category isEqualToString:KCCategoryRetell]) {
            self.textView.text = LocalizedEvaString(KCTextENRetellBase64Encoding, nil);
        }
        else if ([self.iseParams.category isEqualToString:KCCategoryPictureTalk]) {
            self.textView.text = LocalizedEvaString(KCTextENPictureBase64Encoding, nil);
        }
        else if ([self.iseParams.category isEqualToString:KCCategoryOralTranslation]) {
            self.textView.text = LocalizedEvaString(KCTextENTranslationBase64Encoding, nil);
        }
