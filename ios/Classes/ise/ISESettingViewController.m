...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0: {
            ...
            if(![self.iseParams.rstLevel isEqualToString:KCRstLevelPlain]  && ![self.iseParams.category isEqualToString:KCCategoryExpression] && ![self.iseParams.category isEqualToString:KCCategoryChoice] && ![self.iseParams.category isEqualToString:KCCategoryTopic] && ![self.iseParams.category isEqualToString:KCCategoryRetell] && ![self.iseParams.category isEqualToString:KCCategoryPictureTalk] && ![self.iseParams.category isEqualToString:KCCategoryOralTranslation]){//Plain is not supported in Chinese
        ...
        case 1: {
            ...
            [actionSheet addButtonWithTitle:NSLocalizedString(@"K_ISE_CateChapter", nil)];
            ...
            if(![self.iseParams.language isEqualToString:KCLanguageENUS]){//Syllable is not supported in English
                ...
                // update ise_flow 2021.06.01
                [actionSheet addButtonWithTitle:NSLocalizedString(@"K_ISE_CateExpression", nil)];
                [actionSheet addButtonWithTitle:NSLocalizedString(@"K_ISE_CateChoice", nil)];
                [actionSheet addButtonWithTitle:NSLocalizedString(@"K_ISE_CateTopic", nil)];
                [actionSheet addButtonWithTitle:NSLocalizedString(@"K_ISE_CateRetell", nil)];
                [actionSheet addButtonWithTitle:NSLocalizedString(@"K_ISE_CatePictureTalk", nil)];
                [actionSheet addButtonWithTitle:NSLocalizedString(@"K_ISE_CateOralTrans", nil)];
            }
